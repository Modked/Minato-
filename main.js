...
if (!conn.authState.creds.registered) {
  ...
  if (process.argv[2]) { // Changed process.argv[1] to process.argv[2]
            ...
            if (!Object.keys(PHONENUMBER_MCC).some(v => phoneNumber.startsWith(v))) {
                console.log(chalk.bgBlack(chalk.redBright("ابدأ برمز دولة واتساب الخاص بك، مثال: : 967")));
                process.exit(0);
            }
        } else if (!global.pairingNumber) {
            phoneNumber = await question(chalk.bgBlack(chalk.greenBright(`اكتب رقم واتساب الخاص بك : `)));
            phoneNumber = phoneNumber.replace(/[^0-9]/g, '');
            
            // Ask again when entering the wrong number
            if (!Object.keys(PHONENUMBER_MCC).some(v => phoneNumber.startsWith(v))) {
                console.log(chalk.bgBlack(chalk.redBright("ابدأ برمز WhatsApp لبلدك، مثال: : 967")));
...
global.reloadHandler = async function(restatConn) {
    ...
    conn.welcome = '⚇━━━━━━❰･𓃦･❱━━━━━━⚇\n\n> *\`『 نورت اهلا وسهلا انرت شمعة 』\`*  @user ,\n> *\`『 اسم الجروب 』\`* @subject\n\n> *التزم يقلب ساسكي  بقوانين الجروب*\n\n⚇━━━━━━❰･𓃦･❱━━━━━━⚇'
    conn.bye = '⚇━━━━━━❰･⚡･❱━━━━━━⚇\n\n> *\`『 سنشتاق اليك 』\`* @user 🥲\n\n⚇━━━━━━❰･⚡･❱━━━━━━⚇'
    ...
    conn.sAnnounceOn = '*『 تم قفل الجروب 』*'
    conn.sAnnounceOff = '*『 تم فتح الجروب ⚡ 』*'
    conn.sRestrictOn = 'تم تغيير تعديل معلومات المجموعة إلى المسؤولين فقط'
    conn.sRestrictOff = '*『 تم تغيير تعديل معلومات المجموعة إلى جميع المشاركين.⚡ 』*'
